...
string_converter = (str) ->
  ...
  throw "Too long, your string (#{str}) must be less than 40 characters" unless str.length <= 40
...
#console.log string_converter('12Cd') # This one should throw an error
#console.log string_converter('BAZ5678quxabcdefghijklmnopqrstuvwyxz1234567890') # Should also break
